...
Store Information in Database: Only the verbati text RELATED TO SAID PROJECT, TIMESTAMP ANF FILE NAME,  WE WILL ACUMULATE ALL THE DATA WE EXTRACT FORM VARIOUS FILE OVER TIME IN THIS LOG 
...
The document's full verbatim text OF MENTIONED PROJECT ONLY is saved into the ProjectExtractionLog table, linked to this confirmed Project.
